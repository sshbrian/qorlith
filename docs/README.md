...
Brain (`../brain/`) is the Make orchestrator: stills-first (health → plan → stills → board → clips) or Straight to video (health → plan → clips). Artists start it from Make. It talks to Monitor over HTTP.
